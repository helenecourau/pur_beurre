...
data_error = {'count': 0, 'page': 1, 'page_size': 1000,
              'products': [], 'skip': 0}
...
given_value = [{'name': 'Coca-cola',
                        ...
                        'url': 'https://fr.openfoodfacts.org/\
                         produit/5449000267412/coca-cola',
                        'url_img': 'https://static.openfoodfacts.org/images/\
                         products/544/900/026/7412/front_fr.36.400.jpg',
                        'category': 'Sodas,Coca'}]
